...
public class DiamondBarrelBlock extends MinecraftutilitiesModElements.ModElement {
	@ObjectHolder("minecraftutilities:diamond_barrel")
	public static final Block block = null;

	public DiamondBarrelBlock(MinecraftutilitiesModElements instance) {
		super(instance, 44);
	}
