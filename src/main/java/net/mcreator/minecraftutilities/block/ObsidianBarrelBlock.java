...
public class ObsidianBarrelBlock extends MinecraftutilitiesModElements.ModElement {
	@ObjectHolder("minecraftutilities:obsidian_barrel")
	public static final Block block = null;

	public ObsidianBarrelBlock(MinecraftutilitiesModElements instance) {
		super(instance, 42);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("obsidian_barrel");
		}
