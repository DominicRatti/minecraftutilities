...
package net.mcreator.minecraftutilities.keybind;
...
public class OpenBackpackKeyKeyBinding extends MinecraftutilitiesModElements.ModElement {
	...
	public void initElements() {
		keys = new KeyBinding("key.minecraftutilities.open_backpack_key", GLFW.GLFW_KEY_B, "key.categories.minecraftutilities");
